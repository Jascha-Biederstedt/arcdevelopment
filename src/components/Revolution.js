      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            alt="handshake"
            width="100%"
            style={{ maxWidth: 700, marginTop: '5em' }}
          />
        </Grid>
      </Grid>
      <Grid
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            style={{ maxWidth: 1000, marginTop: '5em' }}
          />
        </Grid>
      </Grid>
      <Grid
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            width="100%"
            style={{ maxWidth: matchesMD ? 700 : 1000, marginTop: '5em' }}
          />
        </Grid>
      </Grid>
      <Grid
        ...
        className={classes.rowContainer}
        justify={matchesMD ? 'center' : undefined}
        style={{ backgroundColor: '#C1272D', height: '100em' }}
      >
        <Grid
          item
          container
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            src={launch}
            alt="rocket"
            style={{ maxWidth: 200, marginTop: '5em' }}
            width="100%"
          />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            ...
            style={{ maxWidth: 500, marginTop: '5em' }}
          />
        </Grid>
      </Grid>
      <Grid
