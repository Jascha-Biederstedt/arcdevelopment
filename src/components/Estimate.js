...
const Estimate = () => {
  ...
  return (
    <Grid container className={classes.mainContainer}>
      ...
      >
        <Grid container justify="center" style={{ margin: '2em 0 1em' }}>
          <Grid item>
        ...
        <DialogContent style={{ padding: '2em 0' }}>
          <Grid
            container
              ...
              <Hidden mdUp>
                <Grid item>
                  <Button
                    style={{
                      fontWeight: 300,
                      margin: matchesSM ? '1em 0' : undefined,
                    }}
                    color="primary"
